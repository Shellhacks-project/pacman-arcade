...
function preload() {
  blockImg = loadImage('imgs/block.png');
  block2Img = loadImage('imgs/block2.JPG');
  foodImg = loadImage('imgs/food.png');
  powerImg = loadImage('imgs/power.png');
  angrypacmanImg = loadImage('imgs/pacman_tile.png');
  enemy1Img = loadImage('imgs/ghost1.png');
  enemy2Img = loadImage('imgs/ghost2.png');
  enemy3Img = loadImage('imgs/ghost3.png');
  enemy1ImgWeak = loadImage('imgs/ghost1fear.png');
  enemy2ImgWeak = loadImage('imgs/ghost2fear.png');
  enemy3ImgWeak = loadImage('imgs/ghost3fear.png');
}
